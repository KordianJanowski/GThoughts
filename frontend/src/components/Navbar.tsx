      ...
      <>
        { jwt || !link.jwt ?
          <Link key={link.url} to={`/${link.url}`} className='flex flex-row items-center justify-center xl:justify-start button-animation'>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 ml-1 xl:ml-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className='h-screen w-2/12 2xl:w-60 fixed flex flex-col items-center justify-between py-5'>
        <div className='w-full flex flex-col items-center'>
          ...
          <div className='-ml-2 w-full grid grid-rows-1 gap-4 text-xl mt-2 mb-6 xl:mb-8'>
            { linksMap }
            <div className='flex flex-col xl:flex-row mr-2'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className='h-7 ml-4 button-animation cursor-pointer' onClick={() => setLanguage(LOCALES.POLISH)} viewBox="0 0 640 480">
                <g fill-rule="evenodd">
                  <path fill="#fff" d="M640 480H0V0h640z"/>
                  <path fill="#dc143c" d="M640 480H0V240h640z"/>
                </g>
              </svg>
              <svg xmlns="http://www.w3.org/2000/svg" className='h-7 mt-2 xl:mt-0 ml-4 button-animation cursor-pointer' onClick={() => setLanguage(LOCALES.ENGLISH)} viewBox="0 0 640 480">
